...
async fn main() -> anyhow::Result<()> {
    ...
    let mut protected_routes = Router::new()
        ...
        .route("/nsmf-pdusession/v1/sm-contexts/:smContextRef/send-mo-data", post(handlers::pdu_session::send_mo_data))
        .route("/nsmf-pdusession/v1/pdu-sessions", post(handlers::pdu_session::create_pdu_session_hsmf))
        .route("/nsmf-pdusession/v1/pdu-sessions/:pduSessionRef/modify", post(handlers::pdu_session::modify_pdu_session_hsmf))
        .route("/nsmf-pdusession/v1/pdu-sessions/:pduSessionRef/release", post(handlers::pdu_session::release_pdu_session_hsmf))
        .route("/nsmf-pdusession/v1/pdu-sessions/:pduSessionRef/retrieve", post(handlers::pdu_session::retrieve_pdu_session_hsmf))
        .route("/nsmf-pdusession/v1/pdu-sessions/:pduSessionRef/transfer-mo-data", post(handlers::pdu_session::transfer_mo_data_hsmf))
        .route("/admin/ue-contexts/:supi/sm-contexts", get(handlers::pdu_session::list_ue_pdu_sessions))
        .route("/admin/ue-contexts/:supi/sm-contexts/:pduSessionId", get(handlers::pdu_session::retrieve_pdu_session_by_supi))
        .route("/admin/sm-contexts/:smContextRef/qos-rules", post(handlers::qos_rule::add_qos_rules))
        .route("/admin/sm-contexts/:smContextRef/qos-rules", get(handlers::qos_rule::get_qos_rules))
        .route("/admin/sm-contexts/:smContextRef/qos-rules", delete(handlers::qos_rule::remove_qos_rules))
